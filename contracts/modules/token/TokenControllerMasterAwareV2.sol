...
contract TokenControllerMasterAwareV2 is ITokenController, LockHandler, MasterAwareV2 {
  ...
  */
  function changeDependentContractAddress() public override {
    ...
    assessment = IAssessment(master.getLatestAddress("AS"));
    cover = ICover(master.getLatestAddress("CO"));
    governance = IGovernance(master.getLatestAddress("GV"));
