...
/**
 * Script to get member addresses and their assessment data (stake and rewards)
 *
 * NOTE:
 * execute `npx hardhat run ./scripts/member-roles-addresses.js --network mainnet` to get the latest member addresses
 */
