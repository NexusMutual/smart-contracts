...
export interface UniswapV2Router01Contract
  extends Truffle.Contract<UniswapV2Router01Instance> {
  "new"(
    _factory: string,
    _WETH: string,
    meta?: Truffle.TransactionDetails
  ): Promise<UniswapV2Router01Instance>;
}

type AllEvents = never;

export interface UniswapV2Router01Instance extends Truffle.ContractInstance {
