    ...
    return abi.encodePacked(
      string(
        abi.encodePacked(
          ...
          '<text class="cls-7" x="7%" y="25%"><tspan>Staking Info</tspan></text>',
          '<text class="cls-8" x="7%" y="35%"><tspan>Pool ID:</tspan></text>',
          '<text class="cls-8" x="7%" y="40%"><tspan>Stake:</tspan></text>',
          '<text class="cls-8" x="7%" y="45%"><tspan>NFT ID:</tspan></text>',
          '<text class="cls-8" x="93%" y="35%" text-anchor="end"><tspan>', stakeDescription.poolId.toString(), '</tspan></text>',
          '<text class="cls-8" x="93%" y="40%" text-anchor="end"><tspan>', stakeDescription.stakeAmount.toString(),' NXM</tspan></text>',
