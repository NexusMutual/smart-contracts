...
contract QuotationOld is Iupgradable {
    using SafeMath for uint;

    TokenFunctionsOld internal tf;
    TokenControllerOld internal tc;
    ...
    function changeDependentContractAddress() public onlyInternal {
        ...
        tf = TokenFunctionsOld(ms.getLatestAddress("TF"));
        tc = TokenControllerOld(ms.getLatestAddress("TC"));
