...
interface IAavePool {
  ...
  function setConfiguration(
    address asset,
    AaveDataTypes.ReserveConfigurationMap calldata configuration
  ) external;
  ...
  function getConfiguration(
    address asset
  ) external view returns (AaveDataTypes.ReserveConfigurationMap memory);
  ...
  function getUserConfiguration(
    address user
  ) external view returns (AaveDataTypes.UserConfigurationMap memory);
