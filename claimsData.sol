...
contract claimsData{
    ...
    /// @dev Sets the Escalation Time (in seconds) of claims.
   ...
   /// @return statno Status Number.
    ...
    /// @return vote final verdict of claim 1 if accepted,else -1 if declined.
    ...
    /// @param token token Number of tokens(either accept or deny on the basis of verdict given as parameter).
   ...
   /// @param verdict 1 if claim is accepted,-1 if declined.
    ...
    /// @dev coverid Cover Id.
    /// @dev claimid Claim Id.
