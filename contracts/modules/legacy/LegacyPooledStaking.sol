...
contract LegacyPooledStaking is IPooledStaking, MasterAwareV2 {
  ...
  */
  ...
  function getV1PriceForProduct(uint id) pure public returns (uint96) {
    ...
    if (id == 0) {
      return 16723002302080252000; // 16.723002302080253 %
    }
    ...
    if (id == 11) {
      return 5044868342318268000; // 5.044868342318268 %
    }

    // 0xa4c8d221d8BB851f83aadd0223a8900A6921A349 
    if (id == 13) {
      return 3701343461040968000; // 3.701343461040968 %
    }

    // 0xA51156F3F1e39d1036Ca4ba4974107A1C1815d1e 
    if (id == 16) {
      return 36542530578953036000; // 36.542530578953034 %
    }

    // 0x6354E79F21B56C11f48bcD7c451BE456D7102A36 
    if (id == 17) {
      return 16491512043266447000; // 16.491512043266447 %
    }
    ...
    if (id == 20) {
      return 26465804219290804000; // 26.465804219290803 %
    }
    ...
    if (id == 29) {
      return 2951013551262082600; // 2.9510135512620828 %
    }
    ...
    if (id == 34) {
      return 2655171487398891500; // 2.6551714873988916 %
    }

    // 0x0000000000000000000000000000000000000010 
    if (id == 35) {
      return 3558435145432768500; // 3.5584351454327687 %
    }
