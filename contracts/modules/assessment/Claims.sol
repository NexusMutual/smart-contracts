...
contract Claims is IClaims, RegistryAware {
  ...
  ///
  /// @dev Anyone can call this function, the payout always being transferred to the NFT owner.
  /// When the tokens are transferred the assessment deposit is also sent back.
  ///
