...
contract quotation2 {
    ...
    function addQuote(uint[] arr1 , bytes16[] arr2 ,uint32[] area) {
        qd1 = quotationData(quotationDataAddress);
        m1=MCR(mcrAddress);
