const { hex, categoryParamsToValues } = require('./helpers');
...
const proposalCategories = [
  ...
  ['Set Asset Swap Details', 2, 50, 15, 60, '', 'P1', 'setSwapDetails(address,uint104,uint104,uint16)'], // 41
  ['Add Asset to Pool', 2, 50, 15, 60, '', 'P1', 'addAsset(address,uint104,uint104,uint16,bool)'], // 42
  ...
  ['Set Asset Details', 1, 60, 15, 60, '', 'MS', 'setAssetDetails(uint256,bool,bool)'], // 45
];

module.exports = proposalCategories.map(categoryParamsToValues);
