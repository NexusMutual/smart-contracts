...
contract CoverNFTDescriptor is ICoverNFTDescriptor {
  ...
  function generateDescription(CoverTokenURIParams calldata params) public view returns (string memory descriptionString, CoverDescription memory descriptionData) {
    ...
    if (cover.coverDataCount() < params.tokenId) {
      return ("This NFT does not exist", CoverDescription("", "", "", 0, 0));
    }
    ...
    descriptionData = CoverDescription(productName, assetSymbol, expiry, lastSegment.amount, params.tokenId);
