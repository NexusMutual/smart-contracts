...
const proposalCategories = [
  ...
  ['Upgrade Master', 1, 60, 15, 60, 'Qmdy6PVMFfsowCAvHQXCjNFnqFYCF7UtgRTsNvTp8pU92W', 'MS', 'upgradeTo(address)'],
  ...
  [
    ...
    '',
    'MS',
    'addNewInternalContracts(bytes2[],address[],uint256[])',
  ],
  ['Remove contracts', 1, 60, 15, 60, '', 'MS', 'removeContracts(bytes2[])'],
];
