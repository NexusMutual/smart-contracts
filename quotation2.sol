...
contract quotation2 {
    ...
    function calPremium(uint16 sumAssured , uint32 CP ,uint risk )  constant returns(uint premium) 
    {
        ...
        //uint i1=sumAssured;
        uint32 k=36525;
        uint32 res=(SafeMaths.add32(SafeMaths.div32(SafeMaths.mul32(a,STL),STLP),d));
        ...
        {   
            ...
            {   
                ...
                if(qd1.getQuotationAmountFunded(id)==0)
                {
                  ...
                  if(qd1.getPremiumCalculated(id)>0){
                ...
                else 
                {
                    if(qd1.getPremiumCalculated(id)>0)
                    {
                        ...
                        uint perc = SafeMaths.div((SafeMaths.mul(amountfunded, 100)),(qd1.getPremiumCalculated(id)));
      ...
      function changePremium(uint id , string riskstr) onlyInternal
    {
        ...
        qd1.addInTotalSumAssured(qd1.getQuotationCurrency(id),qd1.getQuotationSumAssured(id));
    }
