...
contract('MemberRoles', function([
  ...
  it('13.10 hould have added initial member roles', async function() {
    const ab = await mr.totalRoles.call();
    assert.equal(ab, 3, 'Initial member roles not created');
  });

  it('13.11 Only owner should be able to update Token controller address', async function() {
  ...
  it('13.12 Only owner should be able to update max AB count', async function() {
