...
export interface GatewayContract extends Truffle.Contract<GatewayInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<GatewayInstance>;
}
...
export interface GatewayInstance extends Truffle.ContractInstance {
