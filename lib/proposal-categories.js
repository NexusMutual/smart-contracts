...
const proposalCategories = [
  ...
  [
    'Upgrade Master Implementation',
    1,
    60,
    15,
    60,
    'Qmdy6PVMFfsowCAvHQXCjNFnqFYCF7UtgRTsNvTp8pU92W',
    'MS',
    'upgradeTo(address)',
  ],
  ...
  ['Update Pool address parameters', 1, 60, 15, 60, '', 'P1', 'updateAddressParameters(bytes8,address)'], // 40
  ['Set Asset Swap Details', 1, 50, 15, 60, '', 'P1', 'setSwapDetails(address,uint256,uint256,uint256)'], // 41
  ['Add Asset to Pool', 1, 50, 15, 60, '', 'P1', 'addAsset(address,bool,uint256,uint256,uint256)'], // 42
  ['Add new contracts', 1, 60, 15, 60, '', 'MS', 'addNewInternalContracts(bytes2[],address[],uint256[])'], // 43
  ['Remove contracts', 1, 60, 15, 60, '', 'MS', 'removeContracts(bytes2[])'], // 44
  // New categories which don't exist at the moment start from here
  ['Set Asset Details', 1, 50, 15, 60, '', 'P1', 'setAssetDetails(uint256,bool,bool)'], // 45
  ['Submit Yield Token Incident', 1, 60, 15, 60, '', 'CG', 'submitIncident(uint24,uint96,uint32,uint256,string)'], // 45
];
