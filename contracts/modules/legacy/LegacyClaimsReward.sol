...
contract LegacyClaimsReward is ILegacyClaimsReward, LegacyMasterAware {
  ...
  function transferRewards() override external {
    ...
    tk.transfer(0x87B2a7559d85f4653f13E6546A14189cd5455d45, 302079121003096787478);
    ...
    tk.transfer(0x6852C2Ac09CcB4B7Cd39BAB7e5427f48d8265da0, 9477779003868504783);
