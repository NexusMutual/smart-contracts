...
contract claimsData is Iupgradable {
    ...
    /// @dev setting the escalation time.
    ...
    /// @dev get the count of all votes.
    ...
    /// @param _claimId Claim Id.
    /// @param _ca if 1: returns the number of votes given by Claim Assessors to a claim, 
