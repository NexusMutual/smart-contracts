...
const proposalCategories = [
  ...
  [
    ...
    15,
    60,
    'QmYwPEYDfHN1Rp799NFRSjbtwya2p2JQsCP9FqLTfAznaD',
    'EX',
    '',
  ],
  [
  ...
  [
    ...
    15,
    80,
    'QmYBx7w7NqhPqXztmgXUtuZDaQYug13DX9BCMYzGgigPCH',
    'EX',
    '',
  ],
  [
...
module.exports = proposalCategories.map(category => {
  ...
  const closingTime = 300; // 604800 on mainnet (7 days)
  const isSpecialResolution = category[3] === 0 ? 1 : 0;
  const allowedToCreateProposal = [2];
