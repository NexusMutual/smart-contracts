...
async function calculateStakingPoolAddress(poolFactoryAddress, poolId) {
  ...
  return getCreate2Address(poolFactoryAddress, salt, initCodeHashHex);
}

module.exports = { calculateStakingPoolAddress };
